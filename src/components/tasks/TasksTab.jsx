                  ...
                  <div className="pt-2 pb-4 px-1">
                    ...
                    <div className="flex md:hidden items-center justify-between mb-4 p-2 bg-gray-50/50 dark:bg-gray-800/30 rounded-xl border border-gray-100 dark:border-gray-700/50">
                      <div className="flex items-center gap-1 ml-1">
                        <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mr-2">Lock:</span>
                        <button 
                      ...
                      <div className="flex items-center gap-1">
                        <button 
                          ...
                          className="p-2 text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg"
                        >
                          <Edit2 className="w-3.5 h-3.5" />
                        </button>
                        <button 
