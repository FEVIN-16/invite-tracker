    ...
    <div className="max-w-7xl mx-auto p-4 md:px-8 md:py-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 transition-colors">
        <div>
          ...
          <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-widest leading-tight">Your global contact book · Organized by group</p>
        </div>
